...
public class Arrow : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        rb.angularDamping = 1.0f; // Some angular drag for stability
        rb.linearDamping = 0.1f; // Some linear drag to simulate air resistance
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (HasLaunched && !rb.isKinematic && rb.linearVelocity.sqrMagnitude > 0.01f)
        {
